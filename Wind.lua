...
B, C=game:GetService("Players"):GetUserThumbnailAsync(
...
b("TextLabel",{
Text=o.User.Anonymous and"Anonymous"or game:GetService("Players").LocalPlayer.DisplayName,
TextSize=17,
ThemeTag={
TextColor3="Text",
},
...
b("TextLabel",{
Text=o.User.Anonymous and"@anonymous"or"@"..game:GetService("Players").LocalPlayer.Name,
TextSize=15,
TextTransparency=.6,
ThemeTag={
TextColor3="Text",
